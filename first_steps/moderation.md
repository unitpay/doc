...
Возможность вывода средств открывается только для партнёров, приславших необходимый пакет документов. В разделе **"Выплаты"** вам следует ознакомиться с действующими офертами, после чего нажать на кнопку **"Согласиться и продолжить"** - вы перейдёте на страницу со списком необходимых для сотрудничества документов и инструкцией по их оформлению.  
**Важно:** Согласиться с офертами в разделе личного кабинета **"Выплаты"** вы сможете сразу после того, как ваш проект пройдёт **первичную проверку.**
