...
Возможность вывода средств открывается только для партнёров, приславших необходимый пакет документов. В разделе "**Выплаты**" вы можете ознакомиться с действующими офертами.  Там же находится белая кнопка "Согласиться и продолжить". Если нажмёте на неё, сможете увидеть полный список требующихся документов и инструкцию по их предоставлению.  
**Важно:** перейти на страницу со списком документов и инструкцией вы сможете только если ваш проект прошёл **первичную проверку** или **окончательную модерацию**. 
